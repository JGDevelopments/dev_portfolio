    ...
    >
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full text-white">
          ...
          <div>
            <button className="group text-white font-medium hover:font-bold w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-emerald-500 to-cyan-600 cursor-pointer">
              Portfolio
